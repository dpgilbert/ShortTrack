...
namespace tas {
	...
	vector<int> &passLooseId() { return cms2.passLooseId(); }
	vector<int> &passMediumId() { return cms2.passMediumId(); }
	vector<int> &passTightId() { return cms2.passTightId(); }
	vector<int> &passVetoId() { return cms2.passVetoId(); }
