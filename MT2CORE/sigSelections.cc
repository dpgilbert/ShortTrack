...
namespace mt2 {
  ...
  std::vector<SR> getSignalRegionsLowMET(){
    ...
    */
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr34[] = {200, 400, 600, 800, 1000, 1400, 1800};
    sr.SetMT2Bins(6, mt2bins_sr34);
    SRVec.push_back(sr);
    sr.Clear();
  ...
  std::vector<SR> getSignalRegionsShortTrack(){
    ...
    // Now add trial short track regions

    // Low Jet, Low HT, 0 b
    sr.SetName("32");
    sr.SetVar("njets", 2, 4);
    sr.SetVar("nbjets", 0, 1);
    sr.SetVar("ht", 250, 450);
    sr.SetVar("met", 250, -1);
    sr.SetVar("nst", 1, -1);
    sr.SetVarCRSL("njets", 2, 4);
    sr.SetVarCRSL("nbjets", 0, 1);
    sr.SetVarCRSL("ht", 250, 450);
    sr.SetVarCRSL("met", 250, -1);
    sr.SetVarCRSL("nst", 1, -1);
    sr.SetVarCRDY("njets", 2, 4);
    sr.SetVarCRDY("nbjets", 0, 1);
    sr.SetVarCRDY("ht", 250, 450);
    sr.SetVarCRDY("met", 250, -1);
    sr.SetVarCRDY("nst", 1, -1);
    sr.SetVarCRQCD("ht", 250, 450);
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr32[] = {200, 300, 1800};
    sr.SetMT2Bins(2, mt2bins_sr32);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr33[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr33);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr34[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr34);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr35[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr35);
    SRVec.push_back(sr);
    sr.Clear();

    // Low Jet, Medium HT, 0 b
    sr.SetName("36");
    sr.SetVar("njets", 2, 4);
    sr.SetVar("nbjets", 0, 1);
    sr.SetVar("ht", 450, 1000);
    sr.SetVar("met", 250, -1);
    sr.SetVar("nst", 1, -1);
    sr.SetVarCRSL("njets", 2, 4);
    sr.SetVarCRSL("nbjets", 0, 1);
    sr.SetVarCRSL("ht", 450, 1000);
    sr.SetVarCRSL("met", 250, -1);
    sr.SetVarCRSL("nst", 1, -1);
    sr.SetVarCRDY("njets", 2, 4);
    sr.SetVarCRDY("nbjets", 0, 1);
    sr.SetVarCRDY("ht", 450, 1000);
    sr.SetVarCRDY("met", 250, -1);
    sr.SetVarCRDY("nst", 1, -1);
    sr.SetVarCRQCD("ht", 450, 1000);
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr36[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr36);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr37[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr37);
    SRVec.push_back(sr);
    sr.Clear();

    // High Jet, Medium HT, 0 b
    sr.SetName("38");
    sr.SetVar("njets", 4, -1);
    sr.SetVar("nbjets", 0, 1);
    sr.SetVar("ht", 450, 1000);
    ...
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr38[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr38);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 250, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr39[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr39);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 30, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr40[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr40);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("met", 30, -1);
    sr.SetVarCRQCD("nst", 1, -1);
    float mt2bins_sr41[] = {200, 1800};
    sr.SetMT2Bins(1, mt2bins_sr41);
    SRVec.push_back(sr);
    sr.Clear();
  ...
  std::vector<SR> getSignalRegionsMonojetShortTrack(){
    ...
    fullSR0b.SetVarCRDY("ht", 250, -1);
    fullSR0b.SetVarCRQCD("ht", 250, -1);
    baseSR.SetVar("nst",0,-1);
    baseSR.SetVarCRSL("nst",0,-1);
    baseSR.SetVarCRDY("nst",0,-1);
    baseSR.SetVarCRQCD("nst",0,-1);
    fullSR0b.SetMT2Bins(nbins_monojet_0b, htbins_0b_forplot);
    SRVec.push_back(fullSR0b);
  ...
  std::vector<SR> getSignalRegionsShortTrackNoTag(){
    ...
    sr.SetVarCRDY("nbjets", 0, 1);
    sr.SetVar("nst",0,-1);
    sr.SetVarCRSL("nst",0,-1);
    sr.SetVarCRDY("nst",0,-1);
    sr.SetVarCRQCD("nst",0,-1);
    temp_SR_vec.push_back(sr);
    sr.Clear();
  ...
  std::vector<SR> getSignalRegionsShortTrackNoTagInclusive(){
    ...
    // Now add trial short track regions, but with no nst cut for comparison purposes
    ...
    sr.SetVar("nst", 1, -1);
    sr.SetVarCRSL("njets", 2, -1);
    sr.SetVarCRSL("ht", 250, 1000);
    sr.SetVarCRSL("met", 250, -1);
    sr.SetVarCRSL("nst", 1, -1);
    sr.SetVarCRSL("nbjets", 0, -1);
    sr.SetVarCRDY("njets", 2, -1);
    sr.SetVarCRDY("ht", 250, 1000);
    sr.SetVarCRDY("met", 250, -1);
    sr.SetVarCRDY("nst", 1, -1);
    sr.SetVarCRDY("nbjets", 0, -1);
    sr.SetVarCRQCD("ht", 450, 1000);
