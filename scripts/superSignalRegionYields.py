...
def main():
    ...
    # 7j3b tight: HT > 1500, MT2 > 400
    datacards_7j3b_tight = [
        'HT1500toInf_j7toInf_b3toInf_m400toInf',
        ]

    # 7j3b loose: HT > 1000, MT2 > 400
    datacards_7j3b_loose = [
        'HT1000toInf_j7toInf_b3toInf_m400to600',
        'HT1000toInf_j7toInf_b3toInf_m600toInf',
        ]

    # 3b tight: HT > 1500, MT2 > 400
    datacards_3b_tight = [
        'HT1500toInf_j2toInf_b3toInf_m400to600',
        'HT1500toInf_j2toInf_b3toInf_m600toInf',
        ]

    # 3b loose: HT > 1000, MT2 > 400
    datacards_3b_loose = [
        'HT1000toInf_j2toInf_b3toInf_m400to600',
        'HT1000toInf_j2toInf_b3toInf_m600toInf',
        ]

    # 7j tight: HT > 1500 && MT2 > 800 
    datacards_7j_tight = [
        'HT1500toInf_j7toInf_b0toInf_m800to1000',
        'HT1500toInf_j7toInf_b0toInf_m1000toInf',
        ]
    
    # 7j loose: HT > 1000 && MT2 > 600
    datacards_7j_loose = [
        'HT1000toInf_j7toInf_b0toInf_m600to800',
        'HT1000toInf_j7toInf_b0toInf_m800to1000',
        'HT1000toInf_j7toInf_b0toInf_m1000toInf',
        ]

    # 4j tight: HT > 1500 && MT2 > 1400
    datacards_4j_tight = [
        'HT1500toInf_j4toInf_b0toInf_m1400toInf',
        ]

    # 4j loose: HT > 1000 && MT2 > 1000
    datacards_4j_loose = [
        'HT1000toInf_j4toInf_b0toInf_m1000to1200',
        'HT1000toInf_j4toInf_b0toInf_m1200toInf',
        ]

    # 2b tight: HT > 1500 && MT2 > 600
    datacards_2b_tight = [
        'HT1500toInf_j2toInf_b2toInf_m600to800',
        'HT1500toInf_j2toInf_b2toInf_m800toInf',
        ]

    # 2b loose: HT > 1000, MT2 > 600
    datacards_2b_loose = [
        'HT1000toInf_j2toInf_b2toInf_m600to800',
        'HT1000toInf_j2toInf_b2toInf_m800to1000',
        'HT1000toInf_j2toInf_b2toInf_m1000toInf',
        ]

    # 2j tight: HT > 1500, MT2 > 1400
    datacards_2j_tight = [
        'HT1500toInf_j2toInf_b0toInf_m1400toInf',
        ]

    # 2j loose: HT > 1000, MT2 > 1200
    datacards_2j_loose = [
        'HT1000toInf_j2toInf_b0toInf_m1000to1200',
        'HT1000toInf_j2toInf_b0toInf_m1200toInf',
        ]
