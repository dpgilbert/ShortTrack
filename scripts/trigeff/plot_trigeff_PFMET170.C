...
void plot_trigeff_PFMET170 (const TString& indir = "/nfs-6/userdata/mt2/V00-01-05_25ns_json_246908-258159_v3_Summer15_25nsV5/") {
  ...
  c->SaveAs("trigeff_PFMET170.pdf");
  c->SaveAs("trigeff_PFMET170.eps");
