...
void plot_trigeff_PFMETNoMu90 (const TString& indir = "/nfs-6/userdata/mt2/V00-01-07_25ns_miniaodv2_Summer15_25nsV6_2p1fb/") {
  ...
  TFile* f_out = new TFile(Form("trigeff_PFMETNoMu90%s.root",suffix.Data()),"RECREATE");
  ...
  c->SaveAs(Form("trigeff_PFMETNoMu90%s.pdf",suffix.Data()));
  c->SaveAs(Form("trigeff_PFMETNoMu90%s.eps",suffix.Data()));
