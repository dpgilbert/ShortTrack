...
public :
   ...
   Int_t           ngamma;
   Float_t         gamma_pt[2];   //[ngamma]
   Float_t         gamma_eta[2];   //[ngamma]
   Float_t         gamma_phi[2];   //[ngamma]
   Float_t         gamma_mass[2];   //[ngamma]
   Int_t           gamma_mcMatchId[2];   //[ngamma]
   Float_t         gamma_chHadIso[2];   //[ngamma]
   Float_t         gamma_neuHadIso[2];   //[ngamma]
   Float_t         gamma_phIso[2];   //[ngamma]
   Float_t         gamma_sigmaIetaIeta[2];   //[ngamma]
   Float_t         gamma_r9[2];   //[ngamma]
   Float_t         gamma_hOverE[2];   //[ngamma]
   Int_t           gamma_idCutBased[2];   //[ngamma]
   Int_t           ngenPart;
   Float_t         genPart_pt[184];   //[ngenPart]
   Float_t         genPart_eta[184];   //[ngenPart]
   Float_t         genPart_phi[184];   //[ngenPart]
   Float_t         genPart_mass[184];   //[ngenPart]
   Int_t           genPart_pdgId[184];   //[ngenPart]
   Float_t         genPart_charge[184];   //[ngenPart]
   Int_t           genPart_motherId[184];   //[ngenPart]
   Int_t           genPart_grandmaId[184];   //[ngenPart]
   Int_t           njet;
   Float_t         jet_pt[42];   //[njet]
   Float_t         jet_eta[42];   //[njet]
   Float_t         jet_phi[42];   //[njet]
   Float_t         jet_mass[42];   //[njet]
   Float_t         jet_btagCSV[42];   //[njet]
   Float_t         jet_rawPt[42];   //[njet]
   Float_t         jet_mcPt[42];   //[njet]
   Int_t           jet_mcFlavour[42];   //[njet]
   Float_t         jet_quarkGluonID[42];   //[njet]
   Float_t         jet_area[42];   //[njet]
   Int_t           jet_id[42];   //[njet]
   Int_t           jet_puId[42];   //[njet]
