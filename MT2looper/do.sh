...
INDIR=/nfs-6/userdata/mt2/V00-08-00_json_Cert_271036-273450_skim_base_mt2gt200_ZinvV4
OUTDIR=output/V00-08-00_json_Cert_271036-273450_skim_base_mt2gt200_ZinvV4
LOGDIR=logs/
...
declare -a Samples=(ttg zinv_ht wjets_ht)
