...
void skim_signal_point(string inpath = "/nfs-6/userdata/mt2/V00-00-03", string outpath = "/nfs-6/userdata/mt2/V00-00-03_skim_nj2_ht450_mt2gt50", string tag = "ttall_msdecays", int mass1 = 1000, int mass2 = 1, string outname = "ttall_msdecays") {
  
  //--------------------------------------------------
  // cut for output files
  //--------------------------------------------------
 
  //  const char* sel = "GenSusyMScan1 == 1700 && GenSusyMScan2 == 600";
