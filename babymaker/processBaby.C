...
void processBaby( TString outfileid = "tt_test", TString infile = "/hadoop/cms/store/group/snt/csa14/MC_CMS3_V07-00-03/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola/merged/merged_ntuple_190.root" )
{
  ...
  else if (infile.Contains("TBarToDilepton_tW-channel"))	     sample = Form("tbarWchanb_2l_%s",  outfileid.Data());
  ...
  else if (infile.Contains("TBarToThadWlep_tW-channel"))	     sample = Form("tbarWchan_thWl_%s", outfileid.Data());
  else if (infile.Contains("TBarToTlepWhad_tW-channel"))	     sample = Form("tbarWchan_tlWh_%s", outfileid.Data());
  else if (infile.Contains("TToDilepton_tW-channel"))	     	     sample = Form("tWchan_2l_%s", 	 outfileid.Data());
  ...
  else if (infile.Contains("TToThadWlep_tW-channel"))	     	     sample = Form("tWchan_thWl_%s", 	 outfileid.Data());
  else if (infile.Contains("TToTlepWhad_tW-channel"))	     	     sample = Form("tWchan_tlWh_%s", 	 outfileid.Data());
  ...
  else if (infile.Contains("T_tW-channel"))                          sample = Form("tWchan_%s",          outfileid.Data());
  else if (infile.Contains("Tbar_tW-channel"))                       sample = Form("tbarWchan_%s",      outfileid.Data());
