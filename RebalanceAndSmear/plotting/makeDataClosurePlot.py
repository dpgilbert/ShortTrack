...
dir_noRS = "looper_output/v6/data_noRS/"
...
leg.AddEntry(hrs, "Data observation")
leg.AddEntry(hnrs, "R&S from data")
leg.Draw()
...
c.SaveAs("/home/users/{0}/public_html/mt2/RebalanceAndSmear/MCtests/data_closure.pdf".format(username))
c.SaveAs("/home/users/{0}/public_html/mt2/RebalanceAndSmear/MCtests/data_closure.png".format(username))
c.SaveAs("/home/users/{0}/public_html/mt2/RebalanceAndSmear/MCtests/data_closure.root".format(username))
