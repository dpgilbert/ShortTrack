...
indir_MC = "looper_output/v6/"
indir_RS = "looper_output/v6/data/"
indir_data = "looper_output/v6/data_noRS/"

username = os.environ["USER"]
outdir = "/home/users/{0}/public_html/mt2/RebalanceAndSmear/data_tests/ICHEP".format(username)
RSfromMC = False
